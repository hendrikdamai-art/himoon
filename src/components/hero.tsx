...
export function Hero() {
  ...
  return (
    <section className="relative h-[520px] overflow-hidden bg-himoon-cream md:h-[620px] lg:h-[680px]">
      <Image
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-white/95 via-white/85 to-white/15 md:from-white/92 md:via-white/70 md:to-transparent" />
