...
export const moneyPageFaqs = [
  ...
  },
  {
    ...
    answer: {
      id: "Harga mengikuti katalog Shopee himoonbabykids. Di situs ini rentang katalog saat ini sekitar Rp22.500–Rp123.000, tergantung produk (tisu Paseo, saringan MPASI, lotion, sunscreen, MPASI, atau popok). Cek Shopee untuk stok dan promo terbaru sebelum checkout.",
